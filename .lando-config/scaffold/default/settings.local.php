...
// ------------------ Best-practice development settings: ------------------

// Load the services.local.yml with further local service settings:
...
if (class_exists('Kint') && property_exists('Kint', 'max_depth')) {
  Kint::$max_depth = 4;
}
...
if (getenv('LANDO') === 'ON') {
  ...
  $local_hostname = getenv('LANDO_APP_NAME') . '.' . getenv('LANDO_DOMAIN');
